    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseCategoryRelations", x => new { x.AncestorId, x.DescendantId });
                    table.ForeignKey(
                        name: "FK_ExpenseCategoryRelations_ExpenseCategories_AncestorId",
                        column: x => x.AncestorId,
                        principalTable: "ExpenseCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpenseCategoryRelations_ExpenseCategories_DescendantId",
            ...
            migrationBuilder.CreateTable(
                name: "HouseholdExpenseCategories",
                columns: table => new
                {
                    HouseholdId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseholdExpenseCategories", x => new { x.HouseholdId, x.ExpenseCategoryId });
                    table.ForeignKey(
                        name: "FK_HouseholdExpenseCategories_ExpenseCategories_ExpenseCategor~",
                        column: x => x.ExpenseCategoryId,
                        principalTable: "ExpenseCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HouseholdExpenseCategories_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseAttachments_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ShareAmount = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    PaymentStatusId = table.Column<int>(type: "integer", nullable: false),
                    StatusUpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseShares_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpenseShares_Users_StatusUpdatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseAttachments_FileId",
                table: "ExpenseAttachments",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseCategoryRelations_DescendantId",
                table: "ExpenseCategoryRelations",
                column: "DescendantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseShares_CreatedBy",
                table: "ExpenseShares",
                column: "CreatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseShares_StatusUpdatedBy",
                table: "ExpenseShares",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseholdExpenseCategories_ExpenseCategoryId",
                table: "HouseholdExpenseCategories",
